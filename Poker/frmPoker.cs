...
namespace Poker
{
    public partial class frmPoker : Form
    {
        ...
        private void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            if (isRoyalisFlush)
            {
                ...
                if (bet != -1)
                {
                    ...
                    label2.Text = bank.ToString();
                    textBox1.Text = "";
                    result = $"{colorList[0]} 同花大順 +{bet * 250}";
                    bet = -1;
                }
                else
                {
            ...
            else if (isFullHouse)
            {
                ...
                if (bet != -1)
                {
                    ...
                    label2.Text = bank.ToString();
                    textBox1.Text = "";
                    result = $"{pointList[0]}三張{pointList[1]}兩張 葫蘆 +{bet * 9}";
                    bet = -1;
                }
                else
                {
            ...
            else if (isTwoPair)
            {
                ...
                if (bet != -1)
                {
                    ...
                    textBox1.Text = "";
                    result = $"{pointList[0]},{pointList[1]} 兩對 +{bet * 2}";
                    bet = -1;
                }
                else
                {
        ...
        {
            bool c = int.TryParse(textBox1.Text,out bet);
            if (!c||bet<1)
            {
                bet = -1;
                textBox1.Text = "";
